...
<div class="jumbotron text-center">
  <h2><spring:message code="multi_title"></spring:message></h2>
  <h3><spring:message code="welcome"></spring:message></h3>
  <select class="form-control" id="selectLan">
  	<option value=""><spring:message code="chlang"></spring:message></option>
  	<option value="ko"><spring:message code="ko"></spring:message></option>
  	<option value="en"><spring:message code="en"></spring:message></option>
  </select>
</div>
<div class="container">
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
     <form class="form-inline" method="post">
       ...
       <button class="btn btn-success" type="submit"><spring:message code="search"></spring:message></button>
     </form>
  </nav>
  <table class="table table-hover">
    ...
    <tbody>
      <tr class="text-center">
        <td><spring:message code="content"></spring:message></td>
      </tr>
    </tbody>
  </table>    
</div>
